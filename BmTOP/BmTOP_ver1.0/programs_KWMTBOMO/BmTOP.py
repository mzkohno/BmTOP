...
print(pycolor.BLUE + "本アプリケーションでは、事前にファイルを用意する必要があります\n\
...
を対象として構築されております\n\n\
それ以外のTableを解析に用いる場合、形式を合わせる必要があります" + pycolor.END)
...
gene_plotter.Rを実行します\n" + pycolor.END)
    ...
    elif os.path.exists("../programs_KWMTBOMO/gene_plotter.R") == False:
        print("この処理を実行するには、下記URLからgene_plotter.Rをダウンロードしてください")
        print("https://github.com/nkimoto/gene_plotter")
    else:

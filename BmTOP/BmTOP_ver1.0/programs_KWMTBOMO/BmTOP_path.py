...
print("BmTOP (Bombyx mori tool for ortholog pick-upper)\nversion 1.0")
...
#        shutil.move('./tblastx_HitTable_THlisted.txt', "../result/data" + str(res) + "/tblastx_HitTable_THlisted.txt") #20190701
...
#        shutil.move('./tblastx_HitTable_sorted.txt', "../result/data" + str(res) + "/tblastx_HitTable_sorted.txt") #20190701
        if os.path.exists("./tblastx_HitTable_sorted_trimAB.txt") == True:
            ...
            # 20190701追加
            if os.path.exists("./tblastx_HitTable_THlisted_trimABC_BmSG.txt") == True:
                shutil.move('./tblastx_HitTable_THlisted_trimABC_BmSG.txt', "../result/data" + str(res) + "/tblastx_HitTable_THlisted_trimABC_BmSG.txt")
            if os.path.exists("./tblastx_HitTable_THlisted_trimABC_notBmSG.txt") == True:
                shutil.move('./tblastx_HitTable_THlisted_trimABC_notBmSG.txt', "../result/data" + str(res) + "/tblastx_HitTable_THlisted_trimABC_notBmSG.txt")
            if os.path.exists("./tblastx_HitTable_sorted_trimABC_BmSG.txt") == True:
                shutil.move('./tblastx_HitTable_sorted_trimABC_BmSG.txt', "../result/data" + str(res) + "/tblastx_HitTable_sorted_trimABC_BmSG.txt")
            if os.path.exists("./tblastx_HitTable_sorted_trimABC_notBmSG.txt") == True:
                shutil.move('./tblastx_HitTable_sorted_trimABC_notBmSG.txt', "../result/data" + str(res) + "/tblastx_HitTable_sorted_trimABC_notBmSG.txt")
            #
    #20190715追加
    if os.path.exists("./ChrZ.png") == True:
        shutil.move('./ChrZ.png', "../result/data" + str(res) + "/ChrZ.png")
        shutil.move('./ChrZ.pdf', "../result/data" + str(res) + "/ChrZ.pdf")
        while chri <= 28:
            shutil.move('./Chr'+ str(chri) + '.png', "../result/data" + str(res) + "/Chr"+ str(chri) + ".png")
            shutil.move('./Chr'+ str(chri) + '.pdf', "../result/data" + str(res) + "/Chr"+ str(chri) + ".pdf")
            chri += 1
        chri = 2
    #
    # ディレクトリの移動
